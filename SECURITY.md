...
- **Always use placeholders** in your public forks.
- **Use n8n Expression Mode** to reference environment variables instead of hardcoding secrets in workflow JSONs.
