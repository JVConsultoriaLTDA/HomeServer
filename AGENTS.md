...
- SOP-style instructions written in Markdown, stored in `agents/directives/`
...
You read `agents/directives/scrape_website.md`, determine inputs/outputs, then run  
`agents/execution/scrape_single_site.py`.

### **Layer 3: Execution (Doing the work)**
- Deterministic Python scripts in `agents/execution/`
...
- Review `agents/execution/` based on the directive
...
- `agents/execution/` – Deterministic scripts
- `agents/directives/` – Markdown SOPs
...
All work must:
- Follow directives defined in `agents/directives/`
- Push repeatable work into deterministic scripts in `agents/execution/`
